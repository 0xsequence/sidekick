...
const StartRewardsSchema = {
    description: 'Schedules an ERC20 token transfer to be executed repeatedly at a specified interval.',
    tags: ['Jobs'],
    params: {
        type: 'object',
    ...
    body: {
        ...
        properties: {
            ...
            repeat_count: {
                type: 'number',
                description: 'How many times to repeat the job. Examples: 1 (once), 2 (twice)'
            }
        }
    },
    response: {
