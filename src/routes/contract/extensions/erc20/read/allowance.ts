...
type erc20AllowanceRequestQuery = {
  owner: string, spender: string
}

type erc20AllowanceRequestParams = {
  chainId: string
...
export async function erc20Allowance(fastify: FastifyInstance) {
  fastify.get<{
    Params: erc20AllowanceRequestParams
    Querystring: erc20AllowanceRequestQuery
    Reply: erc20AllowanceResponse
  }>(
    '/read/erc20/:chainId/:contractAddress/allowance',
