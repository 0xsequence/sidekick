...
type erc721ItemsRenounceRoleRequestBody = {
  role: string, account: string,
  waitForReceipt?: boolean
}

type erc721ItemsRenounceRoleRequestParams = {
  chainId: string
  contractAddress: string
}

type erc721ItemsRenounceRoleResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc721ItemsRenounceRoleSchema = {
  tags: ['erc721Items'],
  body: {
    type: 'object',
...
export async function erc721ItemsRenounceRole(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc721ItemsRenounceRoleRequestParams
    Body: erc721ItemsRenounceRoleRequestBody
    Reply: erc721ItemsRenounceRoleResponse
  }>(
    '/write/erc721Items/:chainId/:contractAddress/renounceRole',
    { schema: erc721ItemsRenounceRoleSchema },
    async (request, reply) => {
      logRequest(request)
