...
type erc721ItemsSetBaseMetadataURIRequestBody = {
  tokenBaseURI: string,
  waitForReceipt?: boolean
}

type erc721ItemsSetBaseMetadataURIRequestParams = {
  chainId: string
  contractAddress: string
}

type erc721ItemsSetBaseMetadataURIResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc721ItemsSetBaseMetadataURISchema = {
  tags: ['erc721Items'],
  body: {
    type: 'object',
...
export async function erc721ItemsSetBaseMetadataURI(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc721ItemsSetBaseMetadataURIRequestParams
    Body: erc721ItemsSetBaseMetadataURIRequestBody
    Reply: erc721ItemsSetBaseMetadataURIResponse
  }>(
    '/write/erc721Items/:chainId/:contractAddress/setBaseMetadataURI',
    { schema: erc721ItemsSetBaseMetadataURISchema },
    async (request, reply) => {
      logRequest(request)
