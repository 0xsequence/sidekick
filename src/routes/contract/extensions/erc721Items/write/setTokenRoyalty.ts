...
type erc721ItemsSetTokenRoyaltyRequestBody = {
  tokenId: string, receiver: string, feeNumerator: string,
  waitForReceipt?: boolean
}

type erc721ItemsSetTokenRoyaltyRequestParams = {
  chainId: string
  contractAddress: string
}

type erc721ItemsSetTokenRoyaltyResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc721ItemsSetTokenRoyaltySchema = {
  tags: ['erc721Items'],
  body: {
    type: 'object',
...
export async function erc721ItemsSetTokenRoyalty(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc721ItemsSetTokenRoyaltyRequestParams
    Body: erc721ItemsSetTokenRoyaltyRequestBody
    Reply: erc721ItemsSetTokenRoyaltyResponse
  }>(
    '/write/erc721Items/:chainId/:contractAddress/setTokenRoyalty',
    { schema: erc721ItemsSetTokenRoyaltySchema },
    async (request, reply) => {
      logRequest(request)
