...
type erc1155SafeBatchTransferFromRequestBody = {
  from: string, to: string, ids: string[], amounts: string[], data: string,
  waitForReceipt?: boolean
}

type erc1155SafeBatchTransferFromRequestParams = {
  chainId: string
  contractAddress: string
}

type erc1155SafeBatchTransferFromResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc1155SafeBatchTransferFromSchema = {
  tags: ['erc1155'],
  body: {
    type: 'object',
...
export async function erc1155SafeBatchTransferFrom(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc1155SafeBatchTransferFromRequestParams
    Body: erc1155SafeBatchTransferFromRequestBody
    Reply: erc1155SafeBatchTransferFromResponse
  }>(
    '/write/erc1155/:chainId/:contractAddress/safeBatchTransferFrom',
    { schema: erc1155SafeBatchTransferFromSchema },
    async (request, reply) => {
      logRequest(request)
