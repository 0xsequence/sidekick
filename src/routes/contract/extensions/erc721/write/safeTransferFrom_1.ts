...
type erc721SafeTransferFrom_1RequestBody = {
  from: string, to: string, tokenId: string,
  waitForReceipt?: boolean
}

type erc721SafeTransferFrom_1RequestParams = {
  chainId: string
  contractAddress: string
}

type erc721SafeTransferFrom_1Response = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc721SafeTransferFrom_1Schema = {
  tags: ['erc721'],
  body: {
    type: 'object',
...
export async function erc721SafeTransferFrom_1(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc721SafeTransferFrom_1RequestParams
    Body: erc721SafeTransferFrom_1RequestBody
    Reply: erc721SafeTransferFrom_1Response
  }>(
    '/write/erc721/:chainId/:contractAddress/safeTransferFrom_1',
    { schema: erc721SafeTransferFrom_1Schema },
    async (request, reply) => {
      logRequest(request)
