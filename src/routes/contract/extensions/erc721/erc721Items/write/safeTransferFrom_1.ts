...
type erc721ItemsSafeTransferFrom_1RequestBody = {
  from: string, to: string, id: string,
  waitForReceipt?: boolean
}

type erc721ItemsSafeTransferFrom_1RequestParams = {
  chainId: string
  contractAddress: string
}

type erc721ItemsSafeTransferFrom_1Response = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc721ItemsSafeTransferFrom_1Schema = {
  tags: ['ERC721Items'],
  body: {
    type: 'object',
    required: ['from', 'to', 'id'],
...
export async function erc721ItemsSafeTransferFrom_1(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc721ItemsSafeTransferFrom_1RequestParams
    Body: erc721ItemsSafeTransferFrom_1RequestBody
    Reply: erc721ItemsSafeTransferFrom_1Response
  }>(
    '/write/erc721Items/:chainId/:contractAddress/safeTransferFrom_1',
    { schema: erc721ItemsSafeTransferFrom_1Schema },
    async (request, reply) => {
      logRequest(request)
