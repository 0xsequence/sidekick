...
type erc721ItemsSetApprovalForAllRequestBody = {
  operator: string, isApproved: string,
  waitForReceipt?: boolean
}

type erc721ItemsSetApprovalForAllRequestParams = {
  chainId: string
  contractAddress: string
}

type erc721ItemsSetApprovalForAllResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc721ItemsSetApprovalForAllSchema = {
  tags: ['ERC721Items'],
  body: {
    type: 'object',
...
export async function erc721ItemsSetApprovalForAll(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc721ItemsSetApprovalForAllRequestParams
    Body: erc721ItemsSetApprovalForAllRequestBody
    Reply: erc721ItemsSetApprovalForAllResponse
  }>(
    '/write/erc721Items/:chainId/:contractAddress/setApprovalForAll',
    { schema: erc721ItemsSetApprovalForAllSchema },
    async (request, reply) => {
      logRequest(request)
