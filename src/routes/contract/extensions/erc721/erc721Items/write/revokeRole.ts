...
type erc721ItemsRevokeRoleRequestBody = {
  role: string, account: string,
  waitForReceipt?: boolean
}

type erc721ItemsRevokeRoleRequestParams = {
  chainId: string
  contractAddress: string
}

type erc721ItemsRevokeRoleResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc721ItemsRevokeRoleSchema = {
  tags: ['ERC721Items'],
  body: {
    type: 'object',
...
export async function erc721ItemsRevokeRole(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc721ItemsRevokeRoleRequestParams
    Body: erc721ItemsRevokeRoleRequestBody
    Reply: erc721ItemsRevokeRoleResponse
  }>(
    '/write/erc721Items/:chainId/:contractAddress/revokeRole',
    { schema: erc721ItemsRevokeRoleSchema },
    async (request, reply) => {
      logRequest(request)
