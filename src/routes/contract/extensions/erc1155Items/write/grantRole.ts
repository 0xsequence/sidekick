...
type erc1155ItemsGrantRoleRequestBody = {
  role: string, account: string,
  waitForReceipt?: boolean
}

type erc1155ItemsGrantRoleRequestParams = {
  chainId: string
  contractAddress: string
}

type erc1155ItemsGrantRoleResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc1155ItemsGrantRoleSchema = {
  tags: ['erc1155Items'],
  body: {
    type: 'object',
...
export async function erc1155ItemsGrantRole(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc1155ItemsGrantRoleRequestParams
    Body: erc1155ItemsGrantRoleRequestBody
    Reply: erc1155ItemsGrantRoleResponse
  }>(
    '/write/erc1155Items/:chainId/:contractAddress/grantRole',
    { schema: erc1155ItemsGrantRoleSchema },
    async (request, reply) => {
      logRequest(request)
