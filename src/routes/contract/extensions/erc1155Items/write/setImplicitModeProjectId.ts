...
type erc1155ItemsSetImplicitModeProjectIdRequestBody = {
  projectId: string,
  waitForReceipt?: boolean
}

type erc1155ItemsSetImplicitModeProjectIdRequestParams = {
  chainId: string
  contractAddress: string
}

type erc1155ItemsSetImplicitModeProjectIdResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc1155ItemsSetImplicitModeProjectIdSchema = {
  tags: ['erc1155Items'],
  body: {
    type: 'object',
    required: ['projectId'],
...
export async function erc1155ItemsSetImplicitModeProjectId(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc1155ItemsSetImplicitModeProjectIdRequestParams
    Body: erc1155ItemsSetImplicitModeProjectIdRequestBody
    Reply: erc1155ItemsSetImplicitModeProjectIdResponse
  }>(
    '/write/erc1155Items/:chainId/:contractAddress/setImplicitModeProjectId',
