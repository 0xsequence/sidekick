...
type erc1155ItemsSetImplicitModeValidatorRequestBody = {
  validator: string,
  waitForReceipt?: boolean
}

type erc1155ItemsSetImplicitModeValidatorRequestParams = {
  chainId: string
  contractAddress: string
}

type erc1155ItemsSetImplicitModeValidatorResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc1155ItemsSetImplicitModeValidatorSchema = {
  tags: ['erc1155Items'],
  body: {
    type: 'object',
    required: ['validator'],
...
export async function erc1155ItemsSetImplicitModeValidator(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc1155ItemsSetImplicitModeValidatorRequestParams
    Body: erc1155ItemsSetImplicitModeValidatorRequestBody
    Reply: erc1155ItemsSetImplicitModeValidatorResponse
  }>(
    '/write/erc1155Items/:chainId/:contractAddress/setImplicitModeValidator',
