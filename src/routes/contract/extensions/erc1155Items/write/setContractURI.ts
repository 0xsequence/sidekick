...
type erc1155ItemsSetContractURIRequestBody = {
  tokenContractURI: string,
  waitForReceipt?: boolean
}

type erc1155ItemsSetContractURIRequestParams = {
  chainId: string
  contractAddress: string
}

type erc1155ItemsSetContractURIResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc1155ItemsSetContractURISchema = {
  tags: ['erc1155Items'],
  body: {
    type: 'object',
...
export async function erc1155ItemsSetContractURI(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc1155ItemsSetContractURIRequestParams
    Body: erc1155ItemsSetContractURIRequestBody
    Reply: erc1155ItemsSetContractURIResponse
  }>(
    '/write/erc1155Items/:chainId/:contractAddress/setContractURI',
    { schema: erc1155ItemsSetContractURISchema },
    async (request, reply) => {
      logRequest(request)
