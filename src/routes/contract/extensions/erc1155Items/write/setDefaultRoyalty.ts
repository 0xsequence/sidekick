...
type erc1155ItemsSetDefaultRoyaltyRequestBody = {
  receiver: string, feeNumerator: string,
  waitForReceipt?: boolean
}

type erc1155ItemsSetDefaultRoyaltyRequestParams = {
  chainId: string
  contractAddress: string
}

type erc1155ItemsSetDefaultRoyaltyResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc1155ItemsSetDefaultRoyaltySchema = {
  tags: ['erc1155Items'],
  body: {
    type: 'object',
...
export async function erc1155ItemsSetDefaultRoyalty(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc1155ItemsSetDefaultRoyaltyRequestParams
    Body: erc1155ItemsSetDefaultRoyaltyRequestBody
    Reply: erc1155ItemsSetDefaultRoyaltyResponse
  }>(
    '/write/erc1155Items/:chainId/:contractAddress/setDefaultRoyalty',
    { schema: erc1155ItemsSetDefaultRoyaltySchema },
    async (request, reply) => {
      logRequest(request)
