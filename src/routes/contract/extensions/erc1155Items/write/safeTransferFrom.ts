...
type erc1155ItemsSafeTransferFromRequestBody = {
  from: string, to: string, id: string, amount: string, data: string,
  waitForReceipt?: boolean
}

type erc1155ItemsSafeTransferFromRequestParams = {
  chainId: string
  contractAddress: string
}

type erc1155ItemsSafeTransferFromResponse = {
  result?: {
    txHash: string | null
    txUrl: string | null
...
const erc1155ItemsSafeTransferFromSchema = {
  tags: ['erc1155Items'],
  body: {
    type: 'object',
...
export async function erc1155ItemsSafeTransferFrom(fastify: FastifyInstance) {
  fastify.post<{
    Params: erc1155ItemsSafeTransferFromRequestParams
    Body: erc1155ItemsSafeTransferFromRequestBody
    Reply: erc1155ItemsSafeTransferFromResponse
  }>(
    '/write/erc1155Items/:chainId/:contractAddress/safeTransferFrom',
    { schema: erc1155ItemsSafeTransferFromSchema },
    async (request, reply) => {
      logRequest(request)
