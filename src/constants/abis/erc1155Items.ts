export const erc1155ItemsAbi = [
	...
	},
	{
		inputs: [
			...
			{ internalType: 'string', name: 'tokenBaseURI', type: 'string' },
			{ internalType: 'string', name: 'tokenContractURI', type: 'string' },
	...
	{
		inputs: [{ internalType: 'string', name: 'tokenBaseURI', type: 'string' }],
